...
export default class About extends React.Component {
  ...
  render() {
    return (
      ...
      <div className="ourteam">About </div>
      <br></br>
      <br></br>
      <br></br>
      <br></br>
      <Grid>
        <Row>
          <Col xs={6} md={4}>
            ...
            Once things lose value, we are less inclinced to reuse and recycle but rather more wasteful. I hope Win-Win solves this issue by motivating
            everyone enough to make the world a cleaner place.</p>
          </Thumbnail>
        </Col>
      </Row>
    </Grid>
